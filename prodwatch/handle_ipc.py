        ...
        if command == "INJECT":
            ...
            if module and original_function:
                def logged_function(*args, **kwargs):
                    ...
                    try:
                        with open(os.environ.get("APP_LOG_FILE", "/app/log_file.txt"), "a") as f:
                            f.write(f"Function {module.__name__}.{function_name} called with args: {args}, kwargs: {kwargs}, result: {result}\n")
